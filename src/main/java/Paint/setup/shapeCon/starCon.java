...
public class starCon {
    ...
    public starCon(allPrefs pref, drawNums dra)
    {
        prefs = pref;
        draw = dra;
    }
    ...
    public void press(MouseEvent event)
    {
        ...
        double[] coords = makeR.buildStar( draw.getPrevX(), draw.getPrevY(),draw.getPrevX()+1, draw.getPrevY()+1);
    ...
    public void drag(MouseEvent event)
    {
        ...
        uniRect makeR = new uniRect(prefs);
        double[] coords = makeR.buildStar( draw.getPrevX(), draw.getPrevY(),draw.getFinX(), draw.getFinY());
